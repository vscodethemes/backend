-- Up migration generated with 'task river -- migrate-get --all --exclude-version 1 --up > river_all.up.sql'
-- Down migration generated with 'task river -- migrate-get --all --exclude-version 1 --down > river_all.down.sql'

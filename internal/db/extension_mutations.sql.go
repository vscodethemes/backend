...
on conflict("vsc_extension_id") do update set
  ...
  "updated_at" = now()
returning id, vsc_extension_id, name, display_name, short_description, publisher_id, publisher_name, publisher_display_name, installs, trending_daily, trending_weekly, trending_monthly, weighted_rating, published_at, released_at, created_at, updated_at, marketplace_updated_at
`
...
type UpsertExtensionParams struct {
	...
	MarketplaceUpdatedAt pgtype.Timestamp
}
